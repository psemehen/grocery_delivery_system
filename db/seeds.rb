...
Supplier.create(name: 'Lidl', groceries_id: 1)
puts 'Suppliers'
...
Product.create(name: 'Bud', sku: SecureRandom.hex(8), supplier: Supplier.first, category: Category.find_by(name: 'Beer'))
Product.create(name: '1715', sku: SecureRandom.hex(8), supplier: Supplier.first, category: Category.find_by(name: 'Beer'))
puts 'Products'
